...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 text-gray-800">
      ...
      <p className="text-sm text-gray-500 mb-6">Last updated: March 22, 2025</p>
      <p className="mb-4">
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        ...
        <li>
          ...
          this Agreement) refers to Tarikh-ul-Hayat.
        </li>
        <li>
        ...
        <li>
          ...
          or content provided by a third-party that may be displayed, included
          or made available by the Service.
        </li>
        <li>
          <strong>Website</strong> refers to Tarikh-ul-Hayat, accessible from{" "}
          <a
            href="https://tarikhulhayat.com"
      ...
      <p className="mb-4">
        ...
        Terms and Your exclusive remedy shall be limited to the amount actually
      ...
      <p className="mb-4">
        ...
        or work with any other software, operate without interruption, or be
        error free.
      </p>
      <p className="mb-4">
        Some jurisdictions do not allow the exclusion of certain types of
        warranties, so some or all of the above exclusions and limitations may
        not apply to You.
      </p>
      ...
      <p className="mb-4">
        ...
        party&apos;s ability to exercise such right at any time thereafter nor
        shall the waiver of a breach constitute a waiver of any subsequent
        breach.
      </p>
      ...
      <ul className="list-disc list-inside mb-4 space-y-2">
        <li>
          <strong>By Email:</strong> support@tarikhulhayat.com
        </li>
      </ul>
    </div>
  );
